...
class BuzzerTeamNode: SKNode {
	...
	convenience init(team: Int) {
		...
		let particles1 = SKEmitterNode(fileNamed: "Particles")!
		...
		let particles2 = SKEmitterNode(fileNamed: "Particles")!
		...
		let particles3 = SKEmitterNode(fileNamed: "Particles")!
		...
		let particles4 = SKEmitterNode(fileNamed: "Particles")!
		...
		let glow = SKEmitterNode(fileNamed: "Particles2")!
