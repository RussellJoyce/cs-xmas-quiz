...
def animationThread():
	...
	while True:
		...
		if onAnimation == u'rainbow':
			...
			strip.show()
			time.sleep(0.00001)
		if onAnimation == u'idle':
			time.sleep(0.00001)
			strip.setPixelColor(random.randrange(0,strip.numPixels()), wheel(random.randrange(0,256)))		
			strip.show()
...
if __name__ == '__main__':
	...
	ws = websocket.WebSocketApp("ws://192.168.1.64:8092",
